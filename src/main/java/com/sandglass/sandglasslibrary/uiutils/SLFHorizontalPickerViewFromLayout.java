...
/**
 * Created by yangjie on 2023/1/12.
 * GitHub: https://github.com/silladus
 * Description:通过布局实现
 */

public class SLFHorizontalPickerViewFromLayout extends RelativeLayout {
    /**
     * 高度，可设置
     */
    private int height = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 44, getResources().getDisplayMetrics());
    /**
     * 可设置的数据数组
     */
    ...
    public SLFHorizontalPickerViewFromLayout(Context context) {
        this(context, null);
    }

    public SLFHorizontalPickerViewFromLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SLFHorizontalPickerViewFromLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    class MyViewGroup extends LinearLayout implements GestureDetector.OnGestureListener {
        ...
        private void initText(Context context) {
            ...
            for (int i = 0; i < 7; i++) {
                ...
                if (i == 3) {
                    mTextView.setTextColor(SLFResourceUtils.getColor(R.color.slf_theme_color));
                } else {
                    mTextView.setTextColor(SLFResourceUtils.getColor(R.color.white));
                }
