...
/**
 * created by yangjie
 * describe:安卓titlebar工具类
 * time: 2022/12/14
 */
@TargetApi(Build.VERSION_CODES.KITKAT)
public class SLFTitleBarUtil {
    private static final String TAG = "SLFTitleBarUtil";
    ...
    public static void setTitleBar(Activity activity, View rootView) {
        ...
        View titleBar;
        if (rootView == null) {
            titleBar = activity.findViewById(R.id.slf_title_bar);
        } else {
            titleBar = rootView.findViewById(R.id.slf_title_bar);
        }
