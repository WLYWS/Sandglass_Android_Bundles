 ...
 * cloud
 */
class SLFLoadingDrawable(val sun: Drawable, val cloud: Drawable) : Drawable(), Animatable {
...
//        invalidateSelf()
    ...
    override fun start() {
        SLFLogUtil.d("loadingdrable","start() -------------------> ")
        startAnim()
    }
    ...
    override fun stop() {
        scope?.cancel()
        scope = null
        SLFLogUtil.d("loadingdrable","ICancelable cancel ---------------------------> ")
    }
