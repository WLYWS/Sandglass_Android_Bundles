 ...
 * </p>
 */
public class SLFSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3,
    ...
    private static final String LOG_TAG = SLFSwipeRefreshLayout.class.getSimpleName();
    ...
    SLFCircleImageView mCircleView;
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        /**
         * Constructor called from {@link SLFSwipeRefreshLayout#onSaveInstanceState()}
         */
     ...
     * @param context
     */
    public SLFSwipeRefreshLayout(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SLFSwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void createProgressView() {
        mCircleView = new SLFCircleImageView(getContext());
    ...
    /**
     * Set a callback to override {@link SLFSwipeRefreshLayout#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link SLFSwipeRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link SLFSwipeRefreshLayout#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(@NonNull SLFSwipeRefreshLayout parent, @Nullable View child);
    }
}
