...
public interface SLFIPhotoView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(SLFPhotoViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(SLFPhotoViewAttacher.OnPhotoTapListener listener);
     ...
     */
    SLFPhotoViewAttacher.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(SLFPhotoViewAttacher.OnViewTapListener listener);
     ...
     */
    SLFPhotoViewAttacher.OnViewTapListener getOnViewTapListener();
     ...
     */
    SLFIPhotoView getIPhotoViewImplementation();
     ...
     */
    void setOnScaleChangeListener(SLFPhotoViewAttacher.OnScaleChangeListener onScaleChangeListener);
}
