...
public class SLFAwbSeekBar extends SeekBar {

    private int mProgress;
    private SLFAwbSeekBar mAwbSeekBar = this;
    private OnAwbSeekBarChangeListener mOnAwbSeekBarChangeListener;

    public SLFAwbSeekBar(Context context) {
        super(context);
        init();
    }

    public SLFAwbSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SLFAwbSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public SLFAwbSeekBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
