...
public class SLFAutoLocateHorizontalView extends RecyclerView {
    /**
    ...
    public SLFAutoLocateHorizontalView(Context context) {
        super(context);
    }

    public SLFAutoLocateHorizontalView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SLFAutoLocateHorizontalView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    /**
     * 设置每次显示多少个item,该方法必须在adapter之前调用
     *
