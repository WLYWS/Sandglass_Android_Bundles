 ...
 * 重新计算预览宽高
 *
 * @fileName: SLFAutoFitTextureView
 * @date: 2023/1/11  17:00
 * @author: yangjie
 */

public class SLFAutoFitTextureView extends TextureView {

    private int mRatioWidth = 0;
    private int mRatioHeight = 0;

    public SLFAutoFitTextureView(Context context) {
        this(context, null);
    }

    public SLFAutoFitTextureView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SLFAutoFitTextureView(Context context, AttributeSet attrs, int defStyle) {
