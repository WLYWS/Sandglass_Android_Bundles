 ...
 * @author ymc
 */
public class SLFVideoPlayer implements SLFIVideoControl {

    private MediaPlayer mMediaPlayer;
    private Surface mSurface;
    private String mVideoFilePath;

    private SLFIVideoControl.PlaySeekTimeListener mPlaySeekTimeListener;
    private SLFIVideoControl.PlayStateListener mPlayStateListener;
    ...
    public SLFVideoPlayer()
    {
        mMediaPlayer = new MediaPlayer();
        mHandlerThread = new HandlerThread(SLFVideoPlayer.class.getSimpleName());
   ...
   //     mMediaPlayer.setLooping(isLoop);
    ...
    @Override
    public void setPlaySeekTimeListener(SLFIVideoControl.PlaySeekTimeListener playSeekTimeListener) {
