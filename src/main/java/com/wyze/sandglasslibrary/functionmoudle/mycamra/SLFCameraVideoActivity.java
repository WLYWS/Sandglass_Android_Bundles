...
import com.wyze.sandglasslibrary.bean.SLFCamraConstant;
import com.wyze.sandglasslibrary.commonui.SLFAutoFitTextureView;
import com.wyze.sandglasslibrary.commonui.SLFAutoLocateHorizontalView;
import com.wyze.sandglasslibrary.commonui.SLFAwbSeekBar;
import com.wyze.sandglasslibrary.functionmoudle.activity.SLFMonitoredActivity;
import com.wyze.sandglasslibrary.interf.SLFICamera2;
import com.wyze.sandglasslibrary.interf.SLFIVideoControl;
...
public class SLFCameraVideoActivity extends SLFBaseActivity implements SLFIVideoControl.PlaySeekTimeListener,
        SLFIVideoControl.PlayStateListener, SLFICamera2.TakePhotoListener,
        SensorEventListener, SLFICamera2.CameraReady, SLFAutoLocateHorizontalView.OnSelectedPositionChangedListener {
     ...
     * 当前的显示面板状态
     */
    public int TEXTURE_STATE = SLFCamraConstant.TEXTURE_PREVIEW_STATE;


    ImageView videoPhoto;

    SLFAutoFitTextureView videoTexture;
    ...
    SLFAutoLocateHorizontalView videoMenu;
     ...
     * 视频播放器
     */
    private SLFVideoPlayer mVideoPlayer;
    /**
     * 相机模式
     */
    private int MODE;
     ...
     * 拍照工具类
     */
    private SLFCameraHelper cameraHelper;
    /**
     * 菜单适配器
     */
    private SLFMenuAdapter mMenuAdapter;
    /**
     * 当前拍照模式
     */
     ...
     * 前 后 摄像头标识
     */
    private SLFICamera2.CameraType mNowCameraType = SLFICamera2.CameraType.BACK;
    /**
     * 单点标识
     */
    ...
    private SLFSenseAdapter sAdapter;
    private SLFEffectAdapter effectAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slf_activity_camera_video);
        initStatusColor();
        initChidView();
        initView();
        initData();
    ...
    private void initChidView(){
        videoPhoto = findViewById(R.id.video_photo);
        videoTexture = findViewById(R.id.video_texture);
        videoRecordSeekBar = findViewById(R.id.video_record_seek_bar);
        videoTime = findViewById(R.id.video_time);
        videoSwitchFlash = findViewById(R.id.video_switch_flash);
        videoSwitchCamera = findViewById(R.id.video_switch_camera);
        videoPlay = findViewById(R.id.video_play);
        videoDelete = findViewById(R.id.video_delete);
        videoMenu = findViewById(R.id.video_menu);
        videoRecord = findViewById(R.id.video_record);
        videoSave = findViewById(R.id.video_save);
        videoMinePlay = findViewById(R.id.video_mine_play);
        videoSeekBar = findViewById(R.id.video_seek_bar);
        videoSeekTime = findViewById(R.id.video_seek_time);
        videoHintText = findViewById(R.id.video_hint_text);
        videoFouces = findViewById(R.id.video_fouces);
        videoMinus = findViewById(R.id.video_minus);
        videoScale = findViewById(R.id.video_scale);
        videoAdd = findViewById(R.id.video_add);
        videoScaleBarLayout = findViewById(R.id.video_scale_bar_layout);
        mLayoutBottom = findViewById(R.id.layout_bottom);
        layoutAe = findViewById(R.id.layout_ae);
        llEffect = findViewById(R.id.layout_effect);
        evEffectList = findViewById(R.id.rv_effect_list);
        llSense = findViewById(R.id.layout_sense);
        evSenseList = findViewById(R.id.rv_sense_list);
        sbAe = findViewById(R.id.sb_ae);
        llAWBSetting = findViewById(R.id.layout_setting);
        sbAWB = findViewById(R.id.awb_seek_bar);
        sbAwb = findViewById(R.id.sb_awb);
        layoutAwb = findViewById(R.id.layout_awb);
        rlCamera = findViewById(R.id.rl_camera);
        switchAe = findViewById(R.id.switch_ae);
        tvSbTxt = findViewById(R.id.txt_sb_txt);
    }
    ...
    protected void initView() {
        ...
        sAdapter = new SLFSenseAdapter(this, AppConstant.senseArr);
        effectAdapter = new SLFEffectAdapter(this,AppConstant.effectArr);
    ...
    private void initCameraMode() {
        ...
        cameraHelper = new SLFCameraHelper(this);
...
//            Log.e(TAG, "onSensorChanged: x: " + x +"   y: "+y +"  z : "+z);
    ...
    private void initListener() {
        sAdapter.setSenseOnItemClickListener(new SLFSenseAdapter.SenseOnItemClickListener() {
            @Override
        ...
        effectAdapter.setEffectOnItemClickListener(new SLFEffectAdapter.EffectOnItemClickListener() {
            @Override
            public void itemOnClick(int position) {
                switch (position) {
                    case 0:
