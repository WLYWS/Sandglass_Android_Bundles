...
public class SLFApiContant {
    ...
    public static final String FEEDBACK_HISTORY_LIST_URL="/feedback/";//获取反馈留言历史
    //public static final String POST_FEEDBACK_URL ="/feedback/{id}/history";// 提交留言
    public static final String POST_FEEDBACK_URL ="/feedback/";// 提交留言
    //public static final String FEEDBACK_LOG_URL ="/feedback/{id}/log";//更新 sendLog，再次上传log
    public static final String FEEDBACK_LOG_URL ="/feedback/";//更新 sendLog，再次上传log
