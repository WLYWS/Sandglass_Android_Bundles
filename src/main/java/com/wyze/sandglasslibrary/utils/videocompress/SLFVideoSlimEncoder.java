...
import com.wyze.sandglasslibrary.utils.videocompress.muxer.SLFCodecInputSurface;
 ...
 */
public class SLFVideoSlimEncoder {

    private static final String TAG = "SLFVideoSlimEncoder";
    ...
    private SLFCodecInputSurface mInputSurface;
    // size of a frame, in pixels
    private float mWidth = -1.0f;
    private float mHeight = -1.0f;
    // bit rate, in bits per second
    private float mBitRate = -1.0f;
     ...
     *
     * */
    public boolean convertVideo(final String sourcePath, String destinationPath, float nwidth, float nheight, float nbitrate, SLFSlimProgressListener listener) {
                            ...
                            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                                ...
                                if (mBufferInfo.size > 1) {
                                    if ((mBufferInfo.flags & MediaCodec.BUFFER_FLAG_CODEC_CONFIG) == 0) {
                                        ...
                                        MediaFormat newFormat = MediaFormat.createVideoFormat(MIME_TYPE, (int)nwidth, (int)nheight);
...
//            }
    ...
    private boolean checkParmsError(String sourcePath, String destinationPath, float nwidth, float nheight, float nbitrate) {
    ...
    private void prepareEncoder(MediaFormat inputFormat) {
        ...
        format.setInteger(MediaFormat.KEY_BIT_RATE, (int)mBitRate);
        ...
        // you will likely want to defer instantiation of SLFCodecInputSurface until after the
